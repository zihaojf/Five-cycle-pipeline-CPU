...
void ceO5NPYidU();
static int J2wT7kA1qf() {
  int ak97Q = read_key();
  int Um4P6 = ak97Q & ~0x8000;
  if (Um4P6 != _KEY_NONE) return Um4P6;
  return _KEY_NONE;
}
static void Z2a9kqQ3rV() {
  uint32_t pVquJtRsOw = (akI2wblQIp / 40 < oT4p6Ulx7J / 40) ? akI2wblQIp / 40 : oT4p6Ulx7J / 40;
  for(uint32_t hck0ckSSZL = 0; hck0ckSSZL < akI2wblQIp / pVquJtRsOw; hck0ckSSZL ++){
    for(uint32_t XD7kFstGd3 = 0; XD7kFstGd3 < oT4p6Ulx7J / pVquJtRsOw; XD7kFstGd3 ++){
      for(uint32_t SU7984_mkw = 0; SU7984_mkw < pVquJtRsOw * pVquJtRsOw; SU7984_mkw++) h72Vdp9m1b[SU7984_mkw] = 0x000000;
      draw_rect(h72Vdp9m1b, hck0ckSSZL * pVquJtRsOw, XD7kFstGd3 * pVquJtRsOw, pVquJtRsOw, pVquJtRsOw);
    }
  }
}
static int Y3vQ9hL2nX() {
  raB0cxTuRP("SPACE: START", akI2wblQIp / 2 - 96, oT4p6Ulx7J / 2 + 32, 2);
  raB0cxTuRP("Q: QUIT", akI2wblQIp / 2 - 56, oT4p6Ulx7J / 2 + 56, 2);
  draw_sync();
  while (1) {
    int Lm8v3 = J2wT7kA1qf();
    if (Lm8v3 == _KEY_SPACE || Lm8v3 == _KEY_RETURN) return 1;
    if (Lm8v3 == _KEY_Q || Lm8v3 == _KEY_ESC) return 0;
  }
}
static int H7eR5nC0pM() {
  raB0cxTuRP("R: RESTART", akI2wblQIp / 2 - 88, oT4p6Ulx7J / 2 + 32, 2);
  raB0cxTuRP("Q: QUIT", akI2wblQIp / 2 - 56, oT4p6Ulx7J / 2 + 56, 2);
  draw_sync();
  while (1) {
    int Lm8v3 = J2wT7kA1qf();
    if (Lm8v3 == _KEY_R || Lm8v3 == _KEY_SPACE || Lm8v3 == _KEY_RETURN) return 1;
    if (Lm8v3 == _KEY_Q || Lm8v3 == _KEY_ESC) return 0;
  }
}
int main() {
