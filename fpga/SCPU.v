...
assign pipe1_allowin = !pipe1_valid || pipe1_ready_go && pipe2_allowin; // 优先�? ! > && > ||
...
assign pipe2_allowin = !pipe2_valid || pipe2_ready_go && pipe3_allowin; // 优先�? ! > && > ||
...
assign pipe3_allowin = !pipe3_valid || pipe3_ready_go && pipe4_allowin; // 优先�? ! > && > ||
...
assign mem_r = ex_mem_MemRead && pipe3_valid;
...
assign pipe4_allowin = !pipe4_valid || pipe4_ready_go ; // 优先�? ! > && > ||
